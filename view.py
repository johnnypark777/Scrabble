...
class View(tk.Tk):
    ...
    # Update after the turn is passed
    ...
    def _set_tile_color(self, btn, txt):
        ...
        if txt == '3' or txt == '4':
            ...
            txt = "black"
        btn.config(bg=color, fg=txt, activeforeground=txt, activebackground=color, width=1, highlightbackground="black",
                   borderwidth=0)
    ...
    def _generate_text(self, frm):
        for i in range(len(self.letters[self.turn.get() - 1])):
            ...
            letter_text = tk.Text(frm, height=1, width=2, borderwidth=1, relief="solid", bg='Beige',
